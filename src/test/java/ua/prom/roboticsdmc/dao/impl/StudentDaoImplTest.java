...
class StudentDaoImplTest {
    ...
    void save_shouldAddStudentToTheTable_whenEnteredDataIsCorrect() {
        ...
        Optional<Student> expectedStudent = Optional.of( Student.builder()
    ...
    void saveAll_shouldAddStudentsToTable_whenEnteredDataIsCorrect() {
        ...
        List<Student> addedStudents = new ArrayList<Student>(Arrays.asList(
                Student.builder().withGroupId(5)
                                 .withFirstName("Christopher")
                                 .withLastName("Thomas").build(),
                Student.builder().withGroupId(3)
    ...
    void findAll_shouldReturnAllStudents_whenThereAreSomeStudentsInTable() {
        ...
        Student.builder().withStudentId(2)
                         .withGroupId(2)
                         .withFirstName("Christopher")
                         .withLastName("Garcia").build(),
        Student.builder().withStudentId(3)
                         .withGroupId(2)
                         .withFirstName("Patricia")
                         .withLastName("Garcia").build(),
        Student.builder().withStudentId(4)
                         .withGroupId(4)
                         .withFirstName("Patricia")
                         .withLastName("Jackson").build(),
        Student.builder().withStudentId(5)
                         .withGroupId(5)
                         .withFirstName("William")
                         .withLastName("Wilson").build(),
        Student.builder().withStudentId(6)
                         .withGroupId(4)
                         .withFirstName("James")
                         .withLastName("Williams").build(),
        Student.builder().withStudentId(7)
                         .withGroupId(2)
                         .withFirstName("Robert")
                         .withLastName("Rodriguez").build(),
        Student.builder().withStudentId(8)
                         .withGroupId(1)
                         .withFirstName("John")
                         .withLastName("Martinez").build(),
        Student.builder().withStudentId(9)
                         .withGroupId(5)
                         .withFirstName("Karen")
                         .withLastName("Garcia").build()));
    ...
    void findStudentsByCourseName_shouldThrowDataBaseSqlRuntimeException_whenThereIsSomeConnectionProblem() throws SQLException {
    ...
    @Test
    @DisplayName("addGroupIdtoStudents method should add Students to Groups")
    void addGroupIdtoStudents_shouldAddStudentsToGroups_whenEnteredDataIsCorrect() {
        ...
        TableUtility.createTablesAndSchema();
        TableUtility.fillStudentTableDefaultData();
        studentDao.addGroupIdtoStudents(addedStudents);
        
        assertEquals(addedStudents, studentDao.findAll());
    }
    
    @Test
    @DisplayName("addGroupIdtoStudents method should throw DataBaseSqlRuntimeException")
    void addGroupIdtoStudents_shouldThrowDataBaseSqlRuntimeException_whenThereIsSomeConnectionProblem() throws SQLException {
        ...
        List<Student> addedStudents = new ArrayList<Student>(Arrays.asList(
            ...
            Exception exception = assertThrows(DataBaseSqlRuntimeException.class,
                    () -> mockStudentDao.addGroupIdtoStudents(addedStudents));
            assertEquals("GroupId is not added to the student table..", exception.getMessage());
