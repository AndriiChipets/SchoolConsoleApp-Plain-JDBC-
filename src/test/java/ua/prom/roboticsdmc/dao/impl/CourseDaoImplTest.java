...
class CourseDaoImplTest {
    ...
    void saveAll_shouldAddAllCoursesToTable_whenEnteredDataIsCorrect() {
        ...
        List<Course> addedCourses = new ArrayList<Course>(Arrays.asList(
                Course.builder().withCourseName("Ukranian").build(),
                Course.builder().withCourseName("Physics").build()));
        
        List<Course> expectedCourses = new ArrayList<Course>(Arrays.asList(
                Course.builder().withCourseId(1).withCourseName("Ukranian").build(),
                Course.builder().withCourseId(2).withCourseName("Physics").build()));
    ...
    void saveAll_shouldThrowDataBaseSqlRuntimeException_whenSomeOfEnteredCourseNameIsAlreadyExist() {
        ...
        List<Course> addedCourses = new ArrayList<Course>(Arrays.asList(
                Course.builder().withCourseName("Math").build(),
                Course.builder().withCourseName("Physics").build()));
    ...
    void findById_shouldReturnCourse_whenThereIsSomeCourseInTableWithEnteredCourseId() {
        ...
        int courseId = 1;
        Optional<Course> expectedCourse = Optional.of(Course.builder().withCourseId(1).withCourseName("Math").build());
    ...
    void update_shouldUpdateCourseInTable_whenEnteredDataIsCorrect() {
        ...
        Optional<Course> expectedCourse = Optional.of(Course.builder().withCourseId(courseId).withCourseName(courseName).build());
    ...
    void getAllStudentCoursesByStudentID_shouldTrowDataBaseSqlRuntimeException_whenThereIsSomeConnectionProblem() throws SQLException {
    ...
    void addStudentToCourse_shouldThrowDataBaseSqlRuntimeException_whenThereIsSomeConnectionProblem() throws SQLException {
    ...
    void removeStudentFromCourse_shouldThrowDataBaseSqlRuntimeException_whenThereIsSomeConnectionProblem() throws SQLException {
    ...
    @Test
    @DisplayName("fillRandomStudentCourseTable method should DataBaseSqlRuntimeException")
    void fillRandomStudentCourseTable_shouldThrowDataBaseSqlRuntimeException_whenThereIsSomeConnectionProblem() throws SQLException {
        ...
        List<List<Integer>> studentIdCoursesIdAdded = new ArrayList<>(Arrays.asList(
            ...
            Exception exception = assertThrows(DataBaseSqlRuntimeException.class,
                    () -> mockCourseDao.fillRandomStudentCourseTable(studentIdCoursesIdAdded));
            assertEquals("CourseID and studentID are not added to the students_course table..", exception.getMessage());
